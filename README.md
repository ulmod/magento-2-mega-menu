...
* Create an unlimited horizontal & vertical menu with diffrents effects
* Support 10 submenu types: anchor text, default category listing, static products listing by category dynamic category listing, category listing by parent, static category listing, , product listing, product grid, dynamic products listing by category, 
content;
* Navigation menu's elements, such as header, main, featured, and footer content
* Support product labels, to draw shoppers attention and drive more sales to your store;
* Support widgets, to easily display a wide range of content;
* Manage all menu and submenu types in the backend
* Support sticky menu
* Ability to export all menus into CSV or XML file. 
